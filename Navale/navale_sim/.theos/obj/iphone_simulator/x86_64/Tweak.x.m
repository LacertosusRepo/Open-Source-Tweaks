...
#define LD_DEBUG NO
  ...
  static BOOL usingFloatingDock = YES;
  static BOOL useColorFlow = YES;
...
static __attribute__((constructor)) void _logosLocalCtor_4075b9d4(int __unused argc, char __unused **argv, char __unused **envp) {
