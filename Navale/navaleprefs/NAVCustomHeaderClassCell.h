...
@implementation NAVCustomHeaderCell
@synthesize iconView, headerLabel, subHeaderLabel;
	...
	-(id)init {
		...
		if(self) {
			...
			self.iconView = [[UIImageView alloc] initWithImage:[[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/navaleprefs.bundle/iconlarge.png"]];
	...
	-(NSArray *)randomLabels {
		return @[@"Gradient for your dock.", @"Try it out with ColorFlow4!", @"Open source on my github!"];
	}
