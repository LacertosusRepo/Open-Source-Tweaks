...
@implementation NAVHeaderCell
	...
	-(id)init {
		...
		if(self) {
			...
			UIImageView *tweakIcon = [[UIImageView alloc] initWithImage:[[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/navaleprefs.bundle/iconlarge.png"]];
      ...
      [self.titleLabel setText:@"Navale"];
	...
	-(NSArray *)randomLabels {
		return @[@"A gradient for your dock", @"Open source on GitHub!", @"Pwn is handing out Unc0ver updates like hotcakes"];
	}
