#include "KWDRootListController.h"

@implementation KWDRootListController
	-(id)init {
		self = [super init];
		if(self) {
	...
	-(void)viewDidLoad {
		...
		UIView *header = [[KWDHeaderView alloc] init];
	...
	-(void)respringConfirm {
		if([self.navigationItem.rightBarButtonItem isEqual:_respringConfirmButton]) {
			...
			_respringConfirmButton.tintColor = [UIColor colorWithRed:0.13 green:0.13 blue:0.13 alpha:1.00];
