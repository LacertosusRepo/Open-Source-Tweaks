#import "DIAHeaderCell.h"

@implementation DIAHeaderCell
	...
	-(id)init {
		...
		if(self) {
			...
			UIImageView *tweakIcon = [[UIImageView alloc] initWithImage:[[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/dialergradientprefs.bundle/iconlarge.png"]];
      ...
      [self.titleLabel setText:@"DialerGradient"];
