...
@implementation VOLHeaderCell
	...
	-(id)init {
		...
		if(self) {
			...
			UIImageView *tweakIcon = [[UIImageView alloc] initWithImage:[[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/volbratexiprefs.bundle/iconlarge.png"]];
      ...
      [self.titleLabel setText:@"VolbrateXI"];
	...
	-(NSArray *)randomLabels {
		return @[@"Feedback for your volume control", @"Open source on github!", @"Who wants to pay for my Epic Mountain Pass?", @"Buzz Buzz"];
	}
