#import "SPCHeaderCell.h"

@implementation SPCHeaderCell
	...
	-(id)init {
		...
		if(self) {
			...
			UIImageView *tweakIcon = [[UIImageView alloc] initWithImage:[[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/speculumprefs.bundle/iconlarge.png"]];
      ...
      [self.titleLabel setText:@"Speculum"];
