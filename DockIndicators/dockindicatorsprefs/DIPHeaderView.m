...
@implementation DIPHeaderView {
	...
	-(instancetype)init {
		...
		if(self) {
			...
			_iconView = [[UIImageView alloc] initWithImage:[[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/dockindicatorsprefs.bundle/iconlarge.png"]];
			_iconView.alpha = 0;
			...
			[_title setText:@"Dock Indicators"];
	...
	-(NSArray *)randomLabels {
		return @[@"Running indicators under your dock apps", @"What do you call a free treadmill? Outside", @"Source code available on GitHub"];
	}
